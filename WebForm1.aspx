    ...
    <div class="container form-container">
        <div class="register-form">
            ...
            <form id="form1" runat="server">
                ...
                <div class="form-group">
                    <asp:TextBox ID="MobileTextBox" runat="server" PlaceHolder="Enter Mobile" CssClass="inputbox form-control"></asp:TextBox>
                ...
                <div class="form-group">
                    <asp:Button ID="SaveButton" runat="server" Text="Register"  CssClass="btn btn-primary btn-block" />
                </div>
